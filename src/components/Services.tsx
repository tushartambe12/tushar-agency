        ...
        <section id="services" className="py-20 bg-neutral-50">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    ...
                    <Card className="md:col-span-2 md:row-span-2 h-[400px] flex flex-col justify-between overflow-hidden group hover:shadow-lg transition-shadow duration-300">
                        <CardHeader>
                            <div className="bg-black w-12 h-12 rounded-lg flex items-center justify-center mb-4 text-white">
                                <Laptop className="h-6 w-6" />
                            </div>
                            <CardTitle className="text-2xl">Next.js Web Development</CardTitle>
                        ...
                        <CardContent className="relative p-0 flex-1 bg-neutral-100 mt-4 group-hover:bg-neutral-200 transition-colors">
                            <img
                    ...
                    <Card className="md:col-span-1 h-[190px] group hover:shadow-lg transition-shadow duration-300">
                        <CardHeader>
                    ...
                    <Card className="md:col-span-3 h-[250px] flex items-center overflow-hidden bg-white border-neutral-200 group hover:shadow-xl transition-shadow duration-300">
                        <div className="grid md:grid-cols-2 w-full h-full">
                            ...
                            <div className="bg-neutral-50 h-full relative overflow-hidden">
                                <img
                                    src="/mobile-dev-3d.png"
                                    alt="Mobile App Design"
                                    className="absolute inset-0 w-full h-full object-cover object-center transform scale-110 group-hover:scale-100 transition-transform duration-500"
                                />
                            </div>
                        </div>
                    </Card>
